...
import 'package:nataleemini/src/widgets/menu_model.dart';
        ...
        child: Column(
          children: [
            UserAccountsDrawerHeader(
              ...
              accountName: Text('Natalee persalae',
                style: TextStyle(color: Colors.white),),
              accountEmail: Text('624235002@parichat.skru.ac.th',style: TextStyle(color: Colors.white),),
